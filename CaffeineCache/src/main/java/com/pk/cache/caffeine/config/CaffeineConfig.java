    ...
    public CacheLoader<Object,Object> cacheLoader(){
        CacheLoader<Object,Object> cacheLoader = new CacheLoader<Object, Object>() {
            ...
            public Object load(Object key) throws Exception{
                logger.info(" This is load key = {}", key);
//                return caffeineService.caffeineServiceTest(key.toString());
                if (String.valueOf(key).equals("kun")){
                    return "kun ni hao " +System.currentTimeMillis();
                }
                    return key + "ni hao" +System.currentTimeMillis();
            }

            @Override
            public Object reload(Object key, Object oldValue) throws Exception {
                logger.info("reload oldValue = " + oldValue);
                try {
